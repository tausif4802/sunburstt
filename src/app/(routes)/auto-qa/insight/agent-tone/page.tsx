...
export default function AgentToneAnalysisPage() {
  ...
  const [fromDate, setFromDate] = useState<string>(defaultRange.from.toISOString().split("T")[0]);
  const [toDate, setToDate] = useState<string>(defaultRange.to.toISOString().split("T")[0]);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ToneAnalysisTable fromDate={fromDate} toDate={toDate} agentId={agentId} />
      <AgentToneChart fromDate={fromDate} toDate={toDate} agentId={agentId} />
      <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2 mb-6">
        <ToneAnalysisChart fromDate={fromDate} toDate={toDate} agentId={agentId} />
        <NegativeToneChart fromDate={fromDate} toDate={toDate} agentId={agentId} />
        <ToneMultiCustomerChart fromDate={fromDate} toDate={toDate} agentId={agentId} />
